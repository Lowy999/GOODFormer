...
class LapPEArgs(Tap):
    pass_as_var: bool = None
    eigen: dict = None
    model: str = None
    dim_pe: int = None
    layers: int = None
    n_heads: int = None
    post_layers: int = None
    raw_norm_type: str = None
...
class CommonArgs(Tap):
    ...
    def process_args(self) -> None:
        ...
        self.posenc_LapPE = LapPEArgs().parse_args(args=self.argv, known_only=True)
